 ...
 */
final class Version20210715085303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1000) DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, publish_year VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
